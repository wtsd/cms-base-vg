...
class Category extends AdminController
{
    ...
    public function listing()
    {
        ...
        $this->template = 'content/lst-category.tpl';
    ...
    public function form($id = 0)
    {
        ...
        $contentsArray['c_type'] = 'category';
        $contentsArray['id'] = $id;

        $contentsArray['categories'] = $obj->getCatsHierarchy();
        $contentsArray['galleries'] = $gallery->getGalleryHierarchy();

        $this->template = 'content/frm-category.tpl';
        return $contentsArray;
    }
